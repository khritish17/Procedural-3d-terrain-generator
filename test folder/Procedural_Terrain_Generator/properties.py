# Procedural_Terrain_Generator/properties.py

import bpy

class PTG_Properties(bpy.types.PropertyGroup):
    """
    Custom Property Group to hold all settings for the Procedural Terrain Generator.
    This group will be attached to bpy.types.Scene.
    """
